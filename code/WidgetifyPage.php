...
class WidgetifyPage extends Page
{
    ...
    public static function prefixCSS($css)
    {
...
class WidgetifyPageController extends ContentController
{
    ...
    public function getTemplateContents($request)
    {
    ...
    public function getWidgetById($request)
    {
        ...
        if ($widget = DataObject::get_by_id('WidgetifyWidget', (int)$widgetId)) {
            ...
            if ($widget->Type == 'Content') {
                $output['Content'] = $widget->Content;
            }
            if ($widget->Type == 'Include') {
                $output['Content'] = '<% include ' . $widget->incFile() . ' %>';
            }
        }
        return json_encode($output);
    }
...
class WidgetifyCallback
{
    ...
    public function __construct($widgetifyContent)
    {
